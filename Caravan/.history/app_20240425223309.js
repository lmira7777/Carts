...
${cart[index].month.map(
  (monthElement) =>{return `<div class="month-list-item">
  <input type="radio" id="${monthElement.month}month"  name="month"/>
  <label for="${monthElement.month}month">
    <div class="circle">
        <div class="dot"></div>
    </div>
    <strong>${monthElement.month} ay</strong> / ayda ${monthElement.price} azn
    </label>
  </div>
  `}
